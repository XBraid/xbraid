...
typedef struct _braid_Core_struct
{
   ...
   braid_Real           **rdtvalues;        /**< Array of pointer to arrays of dt values for refinement  */
   braid_Real            *rdtalloc;         /**< Temporary array for storing refinement dt values at ont time step */
