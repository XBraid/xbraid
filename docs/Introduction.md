...
generated by examples/ex-02.  The "time stepping" data set represents sequential time stepping
was generated using examples/ex-02-sequential.  The time-parallel data set was generated using
examples/ex-02.
   \latexonly
   \begin{figure}[!ht] \centering 
...
To run the baseline sequential time stepper, ex-02-serial, try
