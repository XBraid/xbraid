...
BRAID_HEADERS = _braid.h braid.h _util.h braid_test.h braid_status.h braid_defs.h braid_dist.h

BRAID_FILES = _util.c braid.c _braid.c braid_test.c _braid_status.c braid_dist.c braid_F90_iface.c
