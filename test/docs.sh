...
TESTS=( "cd $docs_dir; make clean; make developer_manual " \
        ...
        "cd $docs_dir; cp developer_manual.pdf $share_dir; chgrp hypre $share_dir/developer_manual.pdf; chmod g+rw $share_dir/developer_manual.pdf" \
        ...
        "cd $docs_dir; cp user_manual.pdf $share_dir; chgrp hypre $share_dir/user_manual.pdf; chmod g+rw $share_dir/user_manual.pdf" )
