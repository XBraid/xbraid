...
TESTS=( "$RunString -np 4 $example_dir/ex-bdf2 -cf 2 -ntime 100 -tol 1e-5" \
        "$RunString -np 4 $example_dir/ex-bdf2 -cf 2 -ntime 100 -tol 1e-10" \
        "$RunString -np 4 $example_dir/ex-bdf2 -cf 10 -ntime 10000 -tol 1e-5" \
        "$RunString -np 4 $example_dir/ex-bdf2 -cf 10 -ntime 10000 -tol 1e-10" )
...
#
lines_to_check="^  time steps.*|^  number of levels.*|^  iterations.*|^  residual norm.*"
#
