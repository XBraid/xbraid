...
#
lines_to_check="^  time steps.*|^  number of levels.*|^  coarsening factor.*|^  num F-C relaxations.*|^  num rels on level 0.*|^  iterations.*|^spatial problem size.*|.*  expl.*|^  my_Write.*|.*warp_Test.*"
#
