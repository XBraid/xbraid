...
#TODO - run through all the params for ex-02

# Run the following regression tests 
TESTS=( "$RunString -np 4 $example_dir/ex-02 -ntime 256 -ml 15 -skip 0" \
        "$RunString -np 4 $example_dir/ex-02 -ntime 256 -ml 15 -fmg 1 -skip 0" \
        "$RunString -np 4 $example_dir/ex-02 -ntime 256 -ml 15 -skip 1" \
        "$RunString -np 4 $example_dir/ex-02 -ntime 256 -ml 15 -fmg 1 -skip 1" \
        "$RunString -np 4 $example_dir/ex-02 -ntime 256 -ml 15 -skip 0 -res " \
        "$RunString -np 4 $example_dir/ex-02 -ntime 256 -ml 15 -fmg 1 -skip 0 -res" \
