...
TESTS=( "$RunString -np 1 $example_dir/ex-01" \
        ...
        "$RunString -np 2 $example_dir/ex-01-refinement -periodic"\
        "$RunString -np 2 $example_dir/ex-01-refinement -refine 4 -periodic" \
        "$RunString -np 2 $example_dir/ex-01-refinement -refine 1 -periodic" )
