...
# combination. 
TESTS=( "$RunString -np 1 $driver_dir/drive-diffusion-2D -pgrid 1 1 1 -nt 128 -nx 17 17 -cfl 0.5 -mi 20 -storage -2 -skip 0" \
        "$RunString -np 1 $example_dir/ex-03   -pgrid 1 1 1 -nt 128 -nx 17 17 -cfl 0.5 -mi 20 -storage -2 -skip 0" \
        "$RunString -np 1 $example_dir/ex-03-serial -pgrid 1 1 -nt 128 -nx 17 17 -cfl 0.5 -storage -2 -skip 0" \
        "$RunString -np 1 $driver_dir/drive-diffusion-2D -pgrid 1 1 1 -nt 128 -nx 17 17 -cfl 0.5 -mi 2 -storage -2 -skip 0" \
        "$RunString -np 1 $example_dir/ex-03   -pgrid 1 1 1 -nt 128 -nx 17 17 -cfl 0.5 -mi 2 -storage -2 -skip 0" \
        "$RunString -np 2 $driver_dir/drive-diffusion-2D -pgrid 1 1 2 -nt 128 -nx 17 17 -cfl 0.5 -mi 2 -storage -2 -skip 0" \
        ...
        "$RunString -np 8 $example_dir/ex-03   -pgrid 1 1 8 -nt 128 -nx 17 17 -ml 2 -mi 2 -storage -2 -skip 0" \
        "$RunString -np 8 $driver_dir/drive-diffusion-2D -pgrid 1 1 8 -nt 128 -nx 17 17 -mc 30 -mi 2 -storage -2 -skip 0" \
        "$RunString -np 8 $example_dir/ex-03   -pgrid 1 1 8 -nt 128 -nx 17 17 -mc 30 -mi 2 -storage -2 -skip 0" \
        "$RunString -np 8 $driver_dir/drive-diffusion-2D -pgrid 1 1 8 -nt 128 -nx 17 17 -nu 5 -mi 2 -storage -2 -skip 0" \
        "$RunString -np 8 $example_dir/ex-03   -pgrid 1 1 8 -nt 128 -nx 17 17 -nu 5 -mi 2 -storage -2 -skip 0" \
        "$RunString -np 8 $driver_dir/drive-diffusion-2D -pgrid 1 1 8 -nt 128 -nx 17 17 -nu0 5 -mi 2 -storage -2 -skip 0" \
        "$RunString -np 8 $example_dir/ex-03   -pgrid 1 1 8 -nt 128 -nx 17 17 -nu0 5 -mi 2 -storage -2 -skip 0" \
        "$RunString -np 8 $driver_dir/drive-diffusion-2D -pgrid 1 1 8 -nt 128 -nx 17 17 -tol 1e-2 -storage -2 -skip 0" \
        "$RunString -np 8 $example_dir/ex-03   -pgrid 1 1 8 -nt 128 -nx 17 17 -tol 1e-2 -storage -2 -skip 0" \
        "$RunString -np 8 $driver_dir/drive-diffusion-2D -pgrid 1 1 8 -nt 128 -nx 17 17 -tol 1e-2 -tnorm 1 -storage -2 -skip 0" \
        "$RunString -np 8 $example_dir/ex-03   -pgrid 1 1 8 -nt 128 -nx 17 17 -tol 1e-2 -tnorm 1 -storage -2 -skip 0" \
        "$RunString -np 8 $driver_dir/drive-diffusion-2D -pgrid 1 1 8 -nt 128 -nx 17 17 -tol 1e-2 -tnorm 3 -storage -2 -skip 0" \
        "$RunString -np 8 $example_dir/ex-03   -pgrid 1 1 8 -nt 128 -nx 17 17 -tol 1e-2 -tnorm 3 -storage -2 -skip 0" \
        "$RunString -np 8 $driver_dir/drive-diffusion-2D -pgrid 1 1 8 -nt 128 -nx 17 17 -cf 32 -mi 2 -storage -2 -skip 0" \
        "$RunString -np 8 $example_dir/ex-03   -pgrid 1 1 8 -nt 128 -nx 17 17 -cf 32 -mi 2 -storage -2 -skip 0" \
        "$RunString -np 8 $driver_dir/drive-diffusion-2D -pgrid 1 1 8 -nt 128 -nx 17 17 -cf0 32 -mi 2 -storage -2 -skip 0" \
        "$RunString -np 8 $example_dir/ex-03   -pgrid 1 1 8 -nt 128 -nx 17 17 -cf0 32 -mi 2 -storage -2 -skip 0" \
        "$RunString -np 8 $driver_dir/drive-diffusion-2D -pgrid 1 1 8 -nt 128 -nx 17 17 -pfmg_mi 3 2 -mi 2 -storage -2 -skip 0" \
        "$RunString -np 8 $example_dir/ex-03   -pgrid 1 1 8 -nt 128 -nx 17 17 -pfmg_mi 3 2 -mi 2 -storage -2 -skip 0" \
        "$RunString -np 8 $driver_dir/drive-diffusion-2D -pgrid 1 1 8 -nt 128 -nx 17 17 -forcing -mi 2 -storage -2 -skip 0" \
        "$RunString -np 8 $example_dir/ex-03   -pgrid 1 1 8 -nt 128 -nx 17 17 -forcing -mi 2 -storage -2 -skip 0" \
        "$RunString -np 8 $driver_dir/drive-diffusion-2D -pgrid 1 1 8 -nt 128 -nx 17 17 -use_rand 0 -mi 2 -storage -2 -skip 0" \
        "$RunString -np 8 $example_dir/ex-03   -pgrid 1 1 8 -nt 128 -nx 17 17 -use_rand 0 -mi 2 -storage -2 -skip 0" \
        "$RunString -np 8 $driver_dir/drive-diffusion-2D -pgrid 1 1 8 -nt 128 -nx 17 17 -fmg 1 -mi 2 -storage -2 -skip 0" \
        "$RunString -np 8 $example_dir/ex-03   -pgrid 1 1 8 -nt 128 -nx 17 17 -fmg -mi 2 -storage -2 -skip 0" \
        "$RunString -np 8 $driver_dir/drive-diffusion-2D -pgrid 1 1 8 -nt 128 -nx 17 17 -fmg 1 -mi 2 -storage -2 -skip 0 -cf0 1" \
        "$RunString -np 8 $example_dir/ex-03   -pgrid 1 1 8 -nt 128 -nx 17 17 -fmg -mi 2 -storage -2 -skip 0 -cf0 1" )
