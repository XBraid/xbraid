...
# 512 procs
nt="8192"; nc="512"; ml="4"
echo "srun -N 1  -n 1     -o ${outd}/${outn}_nc${nc}_ml1           ${ex} ${fargs} -nt ${nt} -ml 1"
echo "srun -N 10 -n ${nc} -o ${outd}/${outn}_nc${nc}_ml${ml}       ${ex} ${fargs} -nt ${nt} -ml ${ml} -cf0 16 "
echo "srun -N 10 -n ${nc} -o ${outd}/${outn}_theta_nc${nc}_ml${ml} ${ex} ${fargs} -nt ${nt} -ml ${ml} -cf0 16 -theta"
echo "srun -N 10 -n ${nc} -o ${outd}/${outn}_Delta_nc${nc}_ml${ml} ${ex} ${fargs} -nt ${nt} -ml ${ml} -cf0 16 ${dargs} "
